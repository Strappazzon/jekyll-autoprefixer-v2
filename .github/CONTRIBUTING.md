...
Before you ask a question, search for existing [Discussions](https://github.com/Strappazzon/jekyll-autoprefixer-v2/discussions/categories/questions) that might help you.  
...
If you then still need to ask a question and need clarification you can [create a discussion](https://github.com/Strappazzon/jekyll-autoprefixer-v2/discussions/new?category=questions).
...
- Take a look at the [issues](https://github.com/Strappazzon/jekyll-autoprefixer-v2/issues) first to make sure your issue/feature hasn't been reported/requested before.  
...
```sh
git clone https://github.com/Strappazzon/jekyll-autoprefixer-v2.git
cd jekyll-autoprefixer-v2/
bin/bootstrap
```
...
Fixes: https://github.com/Strappazzon/jekyll-autoprefixer-v2/issues/322
```
